...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-13243492.873762, 3950926.311135, -13063793.147286, 4081572.869032], maxZoom: 28, minZoom: 1
    })
});
...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new ol.SearchLayer({
      layer: lyr_mockelectionlocations_1,
      colName: 'Location',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-13243492.873762, 3950926.311135, -13063793.147286, 4081572.869032], map.getSize());
